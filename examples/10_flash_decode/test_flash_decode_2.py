...
if __name__ == "__main__":
    ...
    if rank == 0: print(f"[RANK {rank}] --- Initializing and setting up config ---")
    ...
    if rank == 0: print(f"[RANK {rank}] --- Creating mock data ---")
    ...
    shmem.barrier()
    if rank == 0: print(f"[RANK {rank}] Broadcasting Q tensor to all ranks...")
    ...
    if rank == 0:
        ...
        ref_output = final_ref_paged_attn(
            ...
            global_kv_lens_list, sp_gqa_attn.scale, world_size, total_kv_heads, head_dim
        )
